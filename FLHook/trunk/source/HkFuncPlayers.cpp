...
void HkMarkObject(uint iClientID, uint iObject)
{
	if(!iObject)
		return;

	uint iClientIDMark = HkGetClientIDByShip(iObject);
	if(iClientIDMark && ClientInfo[iClientIDMark].bCloaked)
		return;
